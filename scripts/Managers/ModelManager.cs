...
public partial class ModelManager : Node
{
    ...
    public void ClientModelChange(int PeerID, int ActorID, string classname)
    {
        ...
        if (a != null)
        {
            ...
            a.ClientModelReference = ResourceLoader.Load<PackedScene>("res://scenes/actorScenes/Models/" + classname + "Model.tscn", cacheMode: ResourceLoader.CacheMode.Reuse).Instantiate<BaseModel>();
